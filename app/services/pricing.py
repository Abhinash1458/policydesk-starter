"""Premium calculator — pure functions, no database.   *** PHASE 2, EXAMPLE 4: YOUR CODE HERE ***
...
def age_factor(age: int, product: ProductCode) -> float:
    ...
    # TODO (Phase 2, Example 4): four age bands; Motor and non-Motor differ only under 25; negative age -> PricingError
    raise NotImplementedError("Phase 2, Example 4: implement age_factor")
...
def tenure_factor(tenure_years: int) -> float:
    ...
    # TODO (Phase 2, Example 4): look the tenure up in TENURE_FACTORS; anything else -> PricingError
    raise NotImplementedError("Phase 2, Example 4: implement tenure_factor")
...
def add_on_factor(product: ProductCode, add_ons: list[str]) -> float:
    ...
    # TODO (Phase 2, Example 4): 1.0 + each valid loading from ADD_ONS[product]; blanks ignored; unknown add-on -> PricingError
    raise NotImplementedError("Phase 2, Example 4: implement add_on_factor")
...
def calculate_premium(
    *,
    ...
    # TODO (Phase 2, Example 4): validate sum_insured, multiply the factors, apply MIN_PREMIUM, round to 2 dp
    raise NotImplementedError("Phase 2, Example 4: implement calculate_premium")