...
> **You are on the `solution` branch.** Day 1 and Day 2 are fully implemented (80 tests green) plus the optional claim-review
> screen. Students fork and work on `main`; instructors demo from here and use `docs/phase3-reference.md`.
